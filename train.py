...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='models/yolov5s_player.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/player.yaml', help='data.yaml path')
